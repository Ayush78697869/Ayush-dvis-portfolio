...
•	Strong visuals, but green text on green background reduces readability.  

•	Some labels (e.g., small countries) are hard to see.  

*Perception & Comparison:  

•	Uneven pie slices make it hard to compare countries, especially those with similar spending.  

•	“Rest of the World” is massive and visually confusing because it looks like one category.  

*Colour Use:  

•	Theme is consistent, but colours hurt usability (low contrast, blending).  

*Hierarchy:  

•	U.S. and China stand out, which works well.  

•	But other countries are visually minimized.  

 Audience & Communication:  
 
•	Works for general viewers who want a quick impression.  

•	Poor for analysts, students, or anyone who needs accurate comparisons.    
